...
fn reg_class_to_gcc(reg_class: InlineAsmRegClass) -> &'static str {
    match reg_class {
        ...
        InlineAsmRegClass::Mos(MosInlineAsmRegClass::reg) => "r",
        InlineAsmRegClass::Mos(MosInlineAsmRegClass::reg_gpr) => "R",
...
fn dummy_output_type<'gcc, 'tcx>(cx: &CodegenCx<'gcc, 'tcx>, reg: InlineAsmRegClass) -> Type<'gcc> {
    match reg {
        ...
        InlineAsmRegClass::Mos(MosInlineAsmRegClass::reg) => cx.type_i8(),
        InlineAsmRegClass::Mos(MosInlineAsmRegClass::reg_gpr) => cx.type_i8(),
